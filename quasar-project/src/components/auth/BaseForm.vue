        ...
        <q-card class="my_card q-pa-md shadow-2 l-2">
            ...
            <q-card-section>
                <q-form ref="qForm" @submit.prevent="submitForm">
                    ...
                    <q-btn style="border-radius: 8px;" rounded size="md" label="Submit" no-caps class="full-width l-5 text-purple-1 q-mt-md"></q-btn>
                </q-form>
            </q-card-section> 
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            async submitForm() {
                const qForm = this.$refs.qForm as QForm | undefined
                let valid = true
                if (qForm && typeof qForm.validate === 'function') {
                    valid = await qForm.validate()
                }
                if (!valid) return
                ...
                try {
                    ...
                    if (this.closeOnSubmit) this.localShow = false
                } finally {
